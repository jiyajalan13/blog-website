...
<nav>
    <div class="logo">
        <a href="/index.php">Blog<span>Log</span></a>
    </div>

    <div class="nav-links">
        <form action="/search.php" method="GET" style="display: flex; align-items: center; gap: 5px; margin-right: 15px;">
        ...
        <?php if(isset($_SESSION['user'])): ?>
            ...
            <a href="/posts/my-posts.php">My Posts</a>
